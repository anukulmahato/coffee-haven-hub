  ...
  head: () => ({
    meta: [
      { title: "Hearth & Bean — A neighborhood coffee house" },
      {
        name: "description",
        content:
          "Slow-roasted beans, hand-poured espresso, and warm pastries served in a cozy corner of the city.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-6xl flex-col justify-center px-6 py-24">
          <p className="mb-4 font-display text-sm uppercase tracking-[0.3em] text-accent">
            Est. 2014 · Small batch
          </p>
          <h1 className="max-w-2xl text-5xl leading-[1.05] text-cream md:text-7xl">
            Slow coffee for the
            <br />
            long mornings Anukul.
          </h1>
          <p className="mt-6 max-w-xl text-lg text-cream/85">
            We roast in small batches, pour by hand, and bake everything in-house before sunrise.
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            <p className="font-display text-sm uppercase tracking-[0.25em] text-primary/70">
              Our craft
            </p>
            <h2 className="mt-3 text-4xl md:text-5xl">From green bean to your cup.</h2>
            <p className="mt-6 text-muted-foreground">
              Every bag comes from a farm we've visited and roasters we trust. We cup, dial in, and
              pour with the same care every morning — because the difference between good and great
              is the third sip.
            </p>
          ...
          <div className="relative">
            <img
              src={beansImg}
              alt="Coffee beans on rustic wood"
              loading="lazy"
              width={1200}
              height={800}
              className="rounded-lg shadow-2xl shadow-espresso/20"
            />
            <div
              className="absolute -bottom-6 -left-6 hidden h-32 w-32 rounded-lg bg-accent md:block"
              aria-hidden
            />
          </div>
        </div>
      ...
      <section id="visit" className="mx-auto max-w-6xl px-6 py-24">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <img
            ...
            width={1200}
            height={800}
            className="rounded-lg shadow-xl shadow-espresso/20 md:order-2"
          />
